// Demo build (DEMO=1 or VITE_DEMO=1) — what runs on the GitHub Pages deployment.
//
...
//
// Only these three constants are shared with normal builds: Bun replaces DEMO at build
// time, so the demo-only UI folds away and the seed generator — imported dynamically — never
export const DEMO = typeof import.meta.env !== 'undefined' && (import.meta.env.DEMO === '1' || import.meta.env.VITE_DEMO === '1')
